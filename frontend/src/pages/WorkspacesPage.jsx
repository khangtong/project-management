    ...
    <div className="max-w-7xl mx-auto p-8">
      ...
      {showCreate && (
        <div className="mb-6 p-6 rounded-xl bg-white shadow-sm border border-cream-border">
          <h3 className="text-lg font-semibold mb-4 text-charcoal">Create Workspace</h3>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-medium">No workspaces yet. Create your first workspace to get started.</p>
        </div>
      ) : (
...
function WorkspaceCard({ workspace }) {
  ...
  return (
    <div className="p-6 rounded-xl bg-white shadow-sm border border-cream-border">
      ...
      {workspace.description && <p className="mt-1 text-sm text-gray-medium">{workspace.description}</p>}

      <div className="mt-4 space-y-2">
        {projects.map((project) => (
          <div key={project.id} className="flex items-center justify-between p-3 rounded-lg bg-mint-light">
