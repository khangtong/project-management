  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-cream">
      ...
      <div className="relative w-full max-w-md p-8 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.06)] rounded-2xl">
        ...
        <h2 className="text-center text-lg font-semibold text-charcoal mb-1">Welcome back</h2>
        <p className="text-center mb-6 text-sm text-gray-medium">Sign in to continue</p>
        ...
        <p className="mt-6 text-center text-sm text-gray-medium">
          ...
          <Link to="/register" className="font-medium text-mint hover:text-mint/80">
            Register
          </Link>
        </p>
      </div>
